...
class TestAntiQuant(TestCase):
    ...
    def custom_op_exec(self, input_x, scale, offset, dstDtype, srcDtype):
        ...
        output = output.to(dstDtype)
        return output.cpu().detach()

    def npu_op_exec(self, input_x, scale, offset, dstDtype, srcDtype):
        output = torch_npu.npu_anti_quant(input_x, scale, offset=offset, dstDtype=dstDtype, srcDtype=srcDtype)
        return output.cpu().detach()
