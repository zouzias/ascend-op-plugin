...
class TestInplaceMmAllReduceAddRmsNorm(TestCase):
    ...
    @classmethod
    def _test_npu_mm_all_reduce_add_rms_norm_(cls, rank, input_list):
        ...
        gamma = gamma.npu()
        _, norm_out = torch_npu.npu_mm_all_reduce_add_rms_norm_(x1, x2, hcom_name, reduce_op='sum', 
                                                                       residual, gamma, bias=None, comm_turn=0)
    ...
    def test_npu_mm_all_reduce_add_rms_norm_(self):
        world_size = 2
        dtype = np.float16
        data_format = -1
        ...
        self._test_multiprocess(TestInplaceMmAllReduceAddRmsNorm._test_npu_mm_all_reduce_add_rms_norm_,
                                TestInplaceMmAllReduceAddRmsNorm._init_dist_hccl, [expt_out_list, x1_list, x2_list, 
